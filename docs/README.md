# AliensAttack - Документация проекта
...
- **Система обработки ошибок** для надежности
...
- **[Обзор](./getting-started/README.md)** - Общий обзор проекта и возможности
- **[Установка](./getting-started/installation.md)** - Подробная инструкция по установке
- **[Быстрый старт](./getting-started/quick-start.md)** - Запуск за 5 минут

### 🏗️ [Архитектура](./architecture/)
- **[Обзор архитектуры](./architecture/README.md)** - Архитектурные принципы и паттерны
- **[Компоненты системы](./architecture/components.md)** - Детальное описание компонентов
- **[Производительность](./architecture/performance.md)** - Оптимизация и производительность

### 🎮 [Игровые механики](./game-mechanics/)
- **[Обзор механик](./game-mechanics/README.md)** - Все игровые механики XCOM2
- **[Боевая система](./game-mechanics/combat-system.md)** - Детали боевой системы
- **[Система видимости](./game-mechanics/visibility-system.md)** - Механики видимости
- **[Система действий](./game-mechanics/action-system.md)** - Типы действий и AP
- **[Система миссий](./game-mechanics/mission-system.md)** - Типы миссий и цели

### 📋 [Реализация](./implementation/)
- **[Обзор реализации](./implementation/README.md)** - Технические детали реализации
- **[Основные системы](./implementation/core-systems/)** - Боевая система, видимость, действия
- **[Продвинутые системы](./implementation/advanced-systems/)** - Псионика, экология, взлом
- **[Тактические системы](./implementation/tactical-systems/)** - Тактики отряда, стратегический слой

### 🔧 [Техническая документация](./technical/)
- **[Обзор технической документации](./technical/README.md)** - Системы и компоненты
- **[Обработка ошибок](./technical/error-handling.md)** - Система обработки ошибок
- **[Конфигурация](./technical/configuration.md)** - Настройки и конфигурация
- **[Развертывание](./technical/deployment.md)** - Развертывание и мониторинг

### 📖 [API документация](./api/)
- **[Обзор API](./api/README.md)** - Основные принципы API
- **[Основной API](./api/core-api.md)** - Базовые модели и интерфейсы
- **[Боевой API](./api/combat-api.md)** - API боевой системы
- **[UI API](./api/ui-api.md)** - API пользовательского интерфейса
