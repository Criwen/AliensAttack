...
### Field System (`com.aliensattack.field`)
- **OptimizedTacticalField** - Оптимизированное поле с системой видимости
- **TacticalField** - Базовое тактическое поле

### Visualization (`com.aliensattack.visualization`)
- **Combat3DVisualizer** - Главный 3D визуализатор поля боя
- **FieldVisualizer** - Базовый визуализатор поля
- **OptimizedFieldVisualizer** - Оптимизированный визуализатор
