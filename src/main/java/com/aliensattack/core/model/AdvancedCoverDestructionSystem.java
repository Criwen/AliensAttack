...
/**
 * Advanced Cover Destruction System - XCOM 2 Mechanic
 * Implements the system for dynamic cover destruction and partial cover mechanics
 */
@Data
@Builder
@NoArgsConstructor
...
@Getter
@Setter
public class AdvancedCoverDestructionSystem {
    ...
    public AdvancedCoverDestructionSystem(String coverId, String coverName, CoverType coverType) {
