...
/**
 * Advanced Terrain System implementing XCOM 2 terrain mechanics:
 * - Terrain destruction mechanics
 * - Terrain hazard effects
 * - Terrain-based movement penalties
 * - Terrain interaction abilities
 */
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class AdvancedTerrainSystem {
    ...
    public AdvancedTerrainSystem(String terrainId, TerrainType terrainType, Position position) {
