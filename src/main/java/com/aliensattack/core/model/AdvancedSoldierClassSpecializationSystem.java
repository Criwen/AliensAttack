...
/**
 * Advanced Soldier Class Specialization System
 * Implements deep soldier class progression with unique abilities and skill trees
 */
@Data
@Builder
@AllArgsConstructor
public class AdvancedSoldierClassSpecializationSystem {
