...
/**
 * Advanced Mission Failure and Success Conditions System
 * Handles complex mission success/failure conditions with multiple win/loss scenarios
 */
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class AdvancedMissionFailureSuccessConditionsSystem {
    ...
    public enum MissionResult {
        COMPLETE_SUCCESS, PARTIAL_SUCCESS, FAILURE, SQUAD_WIPE, TIMER_EXPIRED, OBJECTIVE_FAILED
    }
