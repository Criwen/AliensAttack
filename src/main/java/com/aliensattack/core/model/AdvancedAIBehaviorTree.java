...
/**
 * Advanced AI Behavior Tree System for XCOM 2 Tactical Combat
 * Provides sophisticated decision-making for alien units with learning capabilities
 */
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class AdvancedAIBehaviorTree {
