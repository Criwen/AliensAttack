...
/**
 * Combat Environment Weather Effects System for environmental combat.
 * Implements weather effects, environmental hazards, and combat modifiers.
 */
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class CombatEnvironmentWeatherEffectsSystem {
