...
/**
 * Advanced Weapon Specialization System implementing XCOM 2 weapon mechanics:
...
@NoArgsConstructor
@AllArgsConstructor
public class AdvancedWeaponSpecialization {
    ...
    public AdvancedWeaponSpecialization(String weaponId, String weaponName, WeaponType weaponType) {
