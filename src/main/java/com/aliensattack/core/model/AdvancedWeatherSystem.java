...
/**
 * Advanced Weather System - XCOM 2 Tactical Combat
 * Implements comprehensive weather patterns, forecasting, and weather-based mission modifiers
 */
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class AdvancedWeatherSystem {
