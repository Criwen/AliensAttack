...
/**
 * Psionic Warfare System for psychic combat mechanics.
 * Implements psionic abilities, energy management, and psychic warfare.
 */
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class PsionicWarfareSystem {
