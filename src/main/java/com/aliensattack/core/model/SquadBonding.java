...
/**
 * Squad Bonding System for unit relationships.
 * Implements bonding mechanics and cooperative abilities.
 */
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class SquadBonding {
    ...
    public SquadBonding(Unit unit1, Unit unit2) {
