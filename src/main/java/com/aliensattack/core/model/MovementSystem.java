...
/**
 * Movement System for unit movement mechanics.
 * Implements movement costs, terrain effects, and pathfinding.
 */
@Data
@Builder
@NoArgsConstructor
...
public class MovementSystem {
    ...
    public MovementSystem(String unitId, int maxMovementPoints) {
        this.unitId = unitId;
