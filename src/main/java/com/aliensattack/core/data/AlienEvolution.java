...
import com.aliensattack.core.systems.AlienEvolutionSystem;
...
public class AlienEvolution {
    ...
    private List<AlienType> evolvedAlienTypes;
    ...
    private void initializeEvolutionPaths() {
        ...
        EvolutionPath aggressivePath = EvolutionPath.builder()
                ...
                .pathType("COMBAT")
                .targetAlienType(AlienType.ADVENT_MUTON)
                .evolutionCost(75)
                .evolutionTime(5)
                .currentProgress(0)
                .maxProgress(100)
        ...
        EvolutionPath psionicPath = EvolutionPath.builder()
                ...
                .pathType("PSIONIC")
                .targetAlienType(AlienType.ADVENT_CODEX)
                .evolutionCost(100)
                .evolutionTime(6)
                .currentProgress(0)
                .maxProgress(120)
