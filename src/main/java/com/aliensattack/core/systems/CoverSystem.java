...
/**
 * Cover System implementing XCOM 2 cover mechanics:
 * - Full cover (75% hit chance reduction)
 * - Half cover (40% hit chance reduction)
 * - Flanking mechanics
 * - Cover destruction
 */
@Data
...
public class CoverSystem {
    ...
    public CoverSystem(String coverId, CoverType coverType, Position position) {
