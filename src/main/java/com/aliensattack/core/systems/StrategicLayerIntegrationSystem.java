...
/**
 * Strategic Layer Integration System for campaign management.
 * Integrates tactical combat with strategic layer decisions.
 */
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class StrategicLayerIntegrationSystem {
    ...
    public enum StrategicProjectType {
        RESEARCH, MANUFACTURING, INTELLIGENCE, DEFENSE, OFFENSIVE
    }
