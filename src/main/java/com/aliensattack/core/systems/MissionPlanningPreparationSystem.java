...
/**
 * Mission Planning Preparation System for mission preparation.
 * Implements mission planning, equipment selection, and preparation mechanics.
 */
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class MissionPlanningPreparationSystem {
    ...
    public static class MissionPlan {
        ...
        // Additional fields for mission planning
        ...
        private String planBonus;
        private String planPenalty;
        private boolean isActive;
        private boolean isCompleted;
        private boolean isFailed;
        private int assignedPlanners;
        private int maxPlanners;
    ...
    /**
     * Get mission planning preparation status
     */
    public String getMissionPlanningPreparationStatus() {
        StringBuilder status = new StringBuilder();
        status.append("Mission Planning Preparation Status:\n");
        status.append("- Preparation Bonus: ").append(preparationBonuses.size()).append("\n");
        status.append("- Planning Points: ").append(preparationProgress.values().stream().mapToInt(Integer::intValue).sum()).append("\n");
        status.append("- Mission Plans: ").append(missionPlans.size()).append("\n");
        status.append("- Preparation Tasks: ").append(preparationEvents.size()).append("\n");
        status.append("- Available Mission Types: ").append(missionBriefings.size()).append("\n");
        status.append("- Available Preparation Levels: ").append(preparationBonuses.size()).append("\n");
