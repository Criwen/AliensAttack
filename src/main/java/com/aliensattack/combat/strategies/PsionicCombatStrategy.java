...
/**
 * Psionic combat strategy: placeholder built on top of tactical defaults
 */
public class PsionicCombatStrategy extends TacticalCombatStrategy {
	@Override
