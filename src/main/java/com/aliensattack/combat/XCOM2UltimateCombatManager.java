...
@Getter
@Setter
public class XCOM2UltimateCombatManager extends UltimateMissionCombatManager {
    ...
    public XCOM2UltimateCombatManager(ITacticalField field, Mission mission) {
        super(field, mission);
        ...
        logCombatEvent("XCOM 2 Ultimate Combat Manager initialized with " + totalMechanics + " mechanics");
    }
    ...
    public String getCombatSummary() {
        ...
        summary.append("=== XCOM 2 ULTIMATE COMBAT SUMMARY ===\n");
